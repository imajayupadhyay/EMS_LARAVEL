...
use App\Services\AutoPunchOutService; // Add this import
...
class PunchController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return inertia('Employee/Punches/Index', [
            ...
            'date' => $date,
            'hasAutoPunchOut' => $punches->where('is_auto_punchout', 1)->isNotEmpty(), // Add this
        ]);
    }
        ...
        try {
            ...
            if (! $latest || $latest->punched_out_at) {
                $punch = Punch::create([
                    ...
                    'is_auto_punchout' => 0, // Explicitly set to 0 for manual punch-in
                ]);
            ...
            $latest->update([
                'punched_out_at' => $now,
                'is_auto_punchout' => 0, // Explicitly set to 0 for manual punch-out
            ]);
